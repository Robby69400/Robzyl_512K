...
class UVK5Radio(chirp_common.CloneModeRadio):
    ...
    def get_memory(self, number):
        ...
        if ch_num > 999:
            mem.name = self._get_vfo_channel_names()[ch_num-1000]
    ...
    def set_settings(self, settings):
        ...
        for element in settings:
            ...
            if elname == "VFO_A_chn":
                ...
                if _mem.ScreenChannel_A < 1000:
                    _mem.MrChannel_A = _mem.ScreenChannel_A
                elif _mem.ScreenChannel_A < 1007:
            ...
            # VFO_B e83
                ...
                if _mem.ScreenChannel_B < 1000:
                    _mem.MrChannel_B = _mem.ScreenChannel_B
                elif _mem.ScreenChannel_B < 1007:
...
################## LAYOUT
    ...
    def set_memory(self, memory):
        ...
        # channels >1000 are the 14 VFO chanells and don't have names
        if number < 1000:
            _mem2 = self._memobj.channelname[number]
